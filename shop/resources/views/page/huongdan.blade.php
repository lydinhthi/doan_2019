...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Hướng dẫn mua hàng</h6>
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('trang-chu')}}">Home</a> / <span>Hướng dẫn</span>
				</div>
			</div>
...
<div class="row">
        <div id="center_column" class="col-sm-12 col-md-12">
          <div class="page-wrap">
            <h1 class="page-header bottom-indent">Hướng dẫn mua hàng</h1>
            <div class="page-content">
              <div class="rte">
                <p><strong>Bạn có thể lựa chọn một trong những cách mua hàng sau</strong></p>

<p><strong>Cách 1:</strong>&nbsp;Gọi điện thoại đến tổng đài&nbsp;<strong>(08-69.237.867)</strong>&nbsp;hoặc&nbsp;<strong>(1800.1060)</strong>&nbsp;từ 7h30-22h&nbsp;(cả CN &amp; ngày lễ) nhân viên chúng tôi luôn sẵn sàng phục vụ bạn.</p>
