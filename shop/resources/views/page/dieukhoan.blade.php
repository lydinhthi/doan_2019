...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Điều khoản</h6>
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('trang-chu')}}">Home</a> / <span>Điều khoản</span>
				</div>
			</div>
...
<div class="row">
        <div id="center_column" class="col-sm-12 col-md-12">
          <div class="page-wrap">
            <h1 class="page-header bottom-indent">Điều khoản</h1>
...
<p><strong>2. Chấp nhận đơn hàng và giá cả</strong></p>
